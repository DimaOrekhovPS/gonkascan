...
- Collateral status uses root `confirmation_weight` as potential weight and root `weight` as effective weight.
...
5. Use root `confirmation_weight` and root `weight` for collateral fields.
