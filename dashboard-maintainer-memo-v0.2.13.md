...
Short version: upgrade v0.2.13 changes how dashboards should compute CPoC confirmation weight, and it requires a cache refresh after the upgrade. This applies to Gonkascan and other similar dashboard deployments.
